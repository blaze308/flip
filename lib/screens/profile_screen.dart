...
import 'wallet_screen_riverpod.dart';
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  child: IconButton(
                    icon: const Icon(Icons.account_balance_wallet, color: Color(0xFF4ECDC4), size: 22),
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  child: IconButton(
                    icon: const Icon(Icons.message_outlined, color: Color(0xFF4ECDC4), size: 22),
                    onPressed: () {
  ...
  Widget build(
    ...
    return Container(
      decoration: const BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: Color(0xFF1D1E33)),
        ),
      ),
      child: child,
    );
